...
function selecion(){
  ...
  switch(opcion){
    ...
    case "15":
      ...
      break;
    case "16":
      document.getElementById("observaciones").value = "Buen día, compa no se puede realizar corrección en OSS ya que actualmente servicio se encuentra suspendido por falta de pago Prueba Integrada xxx";
      break;
    case "17":
    ...
    case "21":
      ...
      break;
    case "22":
      document.getElementById("observaciones").value ="Buen dia, equipo que nos indicas " + entra +" ya aparece en el oss del usuario Prueba Integrada xxx , para cargar paquete de canales en los decodificadores se debe verificar con rescate virtual o lideres.";
      break;
    case "23":
